...
@section('maincontent')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="col-12">
      ...
      <form action="{{route('account.extracost.store')}}"  method="POST"  enctype="multipart/form-data" >
      @csrf
    <div class="card-body">
    <div class="row">
                    ...
                    <div class="col-12 col-sm-4">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="4" required placeholder="Write Description" ></textarea>
                                @error('description')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div> 
