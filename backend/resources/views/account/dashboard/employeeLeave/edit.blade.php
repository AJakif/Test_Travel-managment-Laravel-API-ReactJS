    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
          <form method="post" action="{{route('account.employee.leave.update',[$editdata -> id])}}"  enctype="multipart/form-data">
          @csrf
            <div class="row">              
              ...
              <div class="form-group">
                  ...
                  <select class="form-control select2" name="employee_id" style="width: 100%;">
                    ...
                    <option value="{{$employee->id}}"{{(@$editdata->employee_id==$employee->id)?"selected":""}} >{{$employee->fullname}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
               ...
               <div class="form-group">
                  <label class="col-form-label">Start Date:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" name="start_date"  class="form-control datetimepicker-input" data-target="#reservationdate"  required >
               ...
               <div class="form-group">
                  <label class="col-form-label">End Date:</label>
                    <div class="input-group date" id="reservation" data-target-input="nearest">
                        <input type="text" name="end_date"  class="form-control datetimepicker-input" data-target="#reservation" required>
